...
const PersonalForm = ({ updateStatus }) => {
  ...
  const defaultError = {
    fullnameerror: '', emailerror: '', unameerror: '', pswderror: '', conpswderror: '', countryerror: '', address1error: '', cityerror: '', ziperror: '', stateerror: ''
  }
  let SignInData;
    ...
    <>
      <div>
        <div className="tab-content p-0">
          <div className=" tab-pane  active mt-3" id="personal">
            <div className="mb-3">
